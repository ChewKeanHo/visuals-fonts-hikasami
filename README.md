# Hikasami Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Hikasami is a Cyrillic (ID: `*Cyrl`) and Latin (ID: `*Latn`) Sans Serif font
designed by [The Hikasami Design Team](https://github.com/hikasami/font). Its
design focuses on striking a balance between multiple factors such as
readability, speed of perception, and modern typography. Its art direction is to
provide maximum reading comfort, decent visual pleasure, and modern stylish
professional asthetics.

This font is ideal for any general use covering poster title, poster text,
...
```
Title: Hikasami Font
Creators: The Hikasami Design Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-hikasami
UUID: 91662DC3-EB33-459B-94E8-5ECFA039346E
License: SIL Open Font License (http://scripts.sil.org/OFL)
Repository Made On: 2026-03-30
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-fonts-hikasami
```
